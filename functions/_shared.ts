...
// ⚠ VIP4(1조) 가 너무 빨리 도달돼(고배율+대량 주문) 상위 프레스티지 등급 VIP5~12 를 추가했다.
// VIP4 위로는 누적 거래대금 기준을 약 √10(≈3.16)배씩 올려(2단계마다 10배) VIP12=1경(1e16)까지, 요율은
// 0.001%(VIP4) 아래로 0.0002%(VIP12)까지 완만히 낮춘다. 요율이 0.001% 미만이라 표시는 4자리(`fmtFeeRate`)로.
export const VIP_TIERS = [
  ...
  { tier: 4, minVolume: 1e12, rate: 0.00001 }, // 1조~3조         0.001%
  { tier: 5, minVolume: 3e12, rate: 0.000009 }, // 3조~10조       0.0009%
  { tier: 6, minVolume: 1e13, rate: 0.000008 }, // 10조~30조      0.0008%
  { tier: 7, minVolume: 3e13, rate: 0.000007 }, // 30조~100조     0.0007%
  { tier: 8, minVolume: 1e14, rate: 0.000006 }, // 100조~300조    0.0006%
  { tier: 9, minVolume: 3e14, rate: 0.000005 }, // 300조~1000조   0.0005%
  { tier: 10, minVolume: 1e15, rate: 0.000004 }, // 1000조~3000조 0.0004%
  { tier: 11, minVolume: 3e15, rate: 0.000003 }, // 3000조~1경    0.0003%
  { tier: 12, minVolume: 1e16, rate: 0.000002 }, // 1경~          0.0002%
] as const;
