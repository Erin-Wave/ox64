...
- **⚠ 밸런스의 진실원본은 `functions/_crateData.ts` 하나이고, 확률·가격·가치를 건드렸으면 반드시
  ...
  | --- | --- | --- |
  | naive 회수율(머지 없이 다 팔기) | 78~95% | Lv1 92.3 / Lv2 89.6 / Lv3 85.1% |
  | optimal 회수율(끝까지 머지 후 판매) | 120~155% | Lv1 154.7 / Lv2 146.3 / Lv3 131.9% |
  | 두 정책의 비 | 1.3 이상 | ×1.68 / ×1.63 / ×1.55 |
  | 잭팟이 optimal 에서 차지하는 몫 | 5% 미만 | 3.1 / 4.5 / 3.4% |
